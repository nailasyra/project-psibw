...
// Baca dari JSON body (fetch API) atau fallback ke $_POST
...
$query = mysqli_query($conn,
    "UPDATE mahasiswa SET
        nama='$nama', email='$email', jur='$jur', prodi='$prodi',
        agama=$agama, status=$status, jk=$jk,
        tgl_lahir='$tgl_lahir', tmp_lahir='$tmp_lahir',
