...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <ul>
            ...
            <li><a href="../tabeldosen/dosen.php" class="active"><i class="fas fa-chalkboard-teacher"></i> Data Dosen</a></li>
...
<div class="main">
    ...
    <div class="topbar">
        <div class="topbar-left">
            <h3><i class="fas fa-chalkboard-teacher" style="color:var(--primary);margin-right:8px;"></i>Data Dosen</h3>
    ...
    <div class="content">
        ...
        <div class="toolbar">
            <div class="search-box">
                ...
                <input type="text" id="searchInput" placeholder="Cari nama, NIDN, email...">
            </div>
        ...
        <div class="table-card">
            ...
            <div class="table-card-header">
                <h5><i class="fas fa-table"></i> Daftar Dosen FMIPA</h5>
            ...
            <div class="tbl-wrap">
                <table id="tblDosen">
                    ...
                    <tbody>
                        ...
                        ?>
                        <tr>
                            <td><input type="checkbox" class="row-chk" name="nidn[]" value="<?= $row['nidn'] ?>" onchange="updateSel()"></td>
                            <td><?= $no ?></td>
                            <td><span class="badge-nim"><?= $row['nidn'] ?></span></td>
                            ...
                            <td>
                                <div class="action-group" style="justify-content:center;">
                                    <button type="button" class="btn-detail"
                                        data-bs-toggle="modal" data-bs-target="#detail<?= $row['nidn'] ?>">
                                        <i class="fas fa-eye"></i>
                                    </button>
                                    <a class="btn-edit" href="edit.php?nidn=<?= $row['nidn'] ?>">
                                        <i class="fas fa-pen"></i>
                                    </a>
                                    <a class="btn-delete" href="delete.php?nidn=<?= $row['nidn'] ?>"
                        ...
                        <!-- MODAL DETAIL -->
                        <div class="modal fade" id="detail<?= $row['nidn'] ?>" tabindex="-1">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"><i class="fas fa-id-card me-2"></i>Detail Dosen</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div style="text-align:center; padding-bottom:12px;">
                                            <img src="../foto/<?= htmlspecialchars($row['fotodosen']) ?>"
                                                class="detail-foto"
                                            ...
                                            <span class="detail-nim-badge"><?= $row['nidn'] ?></span>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="detail-row"><span class="detail-label"><i class="fas fa-graduation-cap me-1"></i>Pendidikan</span><span class="detail-val"><?= htmlspecialchars($row['pendidikan']) ?></span></div>
                                    ...
                                    <div class="modal-footer" style="justify-content:flex-end; gap:8px;">
                                        <a href="edit.php?nidn=<?= $row['nidn'] ?>" class="btn-edit" style="padding:7px 16px;">
...
<script>
    ...
    const tbl    = document.getElementById('tblDosen');
    ...
    // Checkbox all (only visible rows)
