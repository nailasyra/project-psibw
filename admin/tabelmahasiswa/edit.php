...
<?php 
 ...
 ?> 
	...
	<table>
	<tr><td colspan="3" style="text-align:center;"><b> FORM EDIT DATA</b></td></tr>
	
	<tr><td>NIM</td><td>:</td><td><input type=text name=nim size=8
	value="<?php echo $row['nim'];?>"></td></tr>
	...
	<tr><td>PRODI</td><td>:</td><td><select name=prodi>
		<?php
			if ($row['prodi'] == '160311') {
		?>
			<option value="<?php echo $row['prodi']; ?>">Matematika</option>
        <?php
			} elseif ($row['prodi'] == '160312') {
        ?>
            <option value="<?php echo $row['prodi']; ?>">Statistika</option>
        <?php
			} elseif ($row['prodi'] == '160313') {
        ?>
            <option value="<?php echo $row['prodi']; ?>">Fisika</option>
        <?php
			} elseif ($row['prodi'] == '160314') {
        ?>
            <option value="<?php echo $row['prodi']; ?>">Kimia</option>
        <?php
			} elseif ($row['prodi'] == '160315') {
        ?>
            <option value="<?php echo $row['prodi']; ?>">Biologi</option>
		<?php
			} elseif ($row['prodi'] == '160316') {
        ?>
            <option value="<?php echo $row['prodi']; ?>">Sistem Informasi</option>
		<?php
			} elseif ($row['prodi'] == '160317') {
        ?>
            <option value="<?php echo $row['prodi']; ?>">Manajemen Informatika</option>
        <?php
			}
        ?>
									<option value=160311>Matematika</option>
									<option value=160312>Statistika</option>
									<option value=160313>Fisika</option>
									<option value=160314>Kimia</option>
									<option value=160315>Biologi</option>
									<option value=160316>Sistem Informasi</option>
									<option value=160317>Manajemen Informatika</option>
									</select>
	</td></tr>
